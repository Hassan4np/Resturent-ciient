...
import { FaDollarSign, FaProcedures, FaUser, } from 'react-icons/fa';
...
const AdminHome = () => {
    ...
    const { data: chaerData = [] } = useQuery({
        queryKey: ['order-stats'],
        queryFn: async () => {
            const res = await axoussecret.get('/order-stats');
            return res.data
    ...
    const paichaerData = chaerData.map(data => {
